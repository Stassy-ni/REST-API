...
from app_main.models import Student, User
from app_main import db, login_manager, Config
from app_main.utils import send_email, send_confirmation_code
...
def mail_config():
    from flask import current_app_main, jsonify
    return jsonify({
        'MAIL_SERVER': current_app_main.config['MAIL_SERVER'],
        'MAIL_PORT': current_app_main.config['MAIL_PORT'],
        'MAIL_USERNAME': current_app_main.config['MAIL_USERNAME'],
        'MAIL_USE_TLS': current_app_main.config['MAIL_USE_TLS'],
        'MAIL_USE_SSL': current_app_main.config['MAIL_USE_SSL']
    })